...
VALUES ('2020-01-30 10:00', 'Завтрак', 500, 100000),
       ...
       ('2020-01-31 00:00', 'Еда на граничное время', 100, 100000),
       ('2020-01-31 10:00', 'Завтрак', 1000, 100000),
       ('2020-01-31 13:00', 'Обед', 500, 100000),
       ('2020-01-31 20:00', 'Ужин', 410, 100000),
       ('2020-02-20 9:00', 'Завтрак', 415, 100000),
       ('2021-01-31 10:00', 'Завтрак админа', 500, 100001),
       ('2021-01-31 13:00', 'Обед админа', 700, 100001),
       ('2021-01-31 20:00', 'Ужин админа', 600, 100001);